	...
	<div class="seoTitles view">
		...
		<dl><?php $i = 0; $class = ' class="altrow"';?>
			...
			<dd<?php if ($i++ % 2 == 0) echo $class;?>>
				<?php echo h($seoTitle['SeoTitle']['id']); ?>
				&nbsp;
			</dd>
			<dt<?php if ($i % 2 == 0) echo $class;?>><?php echo __('Seo Uri'); ?></dt>
			<dd<?php if ($i++ % 2 == 0) echo $class;?>>
				<?php echo $this->Html->link(__($seoTitle['SeoUri']['uri']), array('controller' => 'seo_uris', 'action' => 'view', $seoTitle['SeoUri']['id'])); ?>
				&nbsp;
			</dd>
			<dt<?php if ($i % 2 == 0) echo $class;?>><?php echo __('Title'); ?></dt>
			<dd<?php if ($i++ % 2 == 0) echo $class;?>>
				<?php echo h($seoTitle['SeoTitle']['title']); ?>
				&nbsp;
			</dd>
			<dt<?php if ($i % 2 == 0) echo $class;?>><?php echo __('Created'); ?></dt>
			<dd<?php if ($i++ % 2 == 0) echo $class;?>>
				<?php echo h($seoTitle['SeoTitle']['created']); ?>
				&nbsp;
			</dd>
			<dt<?php if ($i % 2 == 0) echo $class;?>><?php echo __('Modified'); ?></dt>
			<dd<?php if ($i++ % 2 == 0) echo $class;?>>
				<?php echo h($seoTitle['SeoTitle']['modified']); ?>
				&nbsp;
			</dd>
		</dl>
	</div>

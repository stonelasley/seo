...
CakePHP-Seo-Plugin loves to welcome your contributions. There are several ways to help out:
...
* Contribute to the [documentation](https://github.com/stonelasley/CakePHP-Seo-Plugin/tree/gh-pages)
...
CakePHP-Seo-Plugin tests requires [PHPUnit](http://www.phpunit.de/manual/current/en/installation.html)
3.5 or higher. To run the testcases locally use the following command:

    ./lib/Cake/Console/cake test CakePHP-Seo-Plugin AllCakePHP-Seo-Plugin

To run the sniffs for CakePHP coding standards

    phpcs -p --extensions=php --standard=CakePHP ./app/Plugin/CakePHP-Seo-Plugin
...
* [Bug tracker](https://github.com/stonelasley/CakePHP-Seo-Plugin/issues)
